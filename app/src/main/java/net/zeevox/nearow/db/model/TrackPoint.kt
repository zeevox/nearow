...
data class TrackPoint(
     ...
     *
     * This is a separate field because the speed here may be more accurate
     * than would be obtained simply by calculating distance / time for
     * sequential positions if, for example, the Doppler measurements from
     * GNSS satellites are taken into account.
     */
    @ColumnInfo(name = "speed") val speed: Float?,

    /**
     * Automatically incremented point ID. For simple sequential ordering.
     * It is placed last in the constructor so that it is not necessary to
     * use named arguments when creating a new trackpoint.
     */
